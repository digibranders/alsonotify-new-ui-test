...
function MeetingItem({ title, time, duration, attendees, totalAttendees, platform, organizer }: { title: string; time: string; duration: string; attendees: { name: string; avatar: string }[]; totalAttendees: number; platform: string; organizer: string }) {
  return (
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between gap-2 mb-2">
            ...
            <span className={`px-2 py-0.5 rounded-full text-[10px] font-['Manrope:Medium',sans-serif] flex-shrink-0 bg-[#E3F2FD] text-[#1565C0]`}>
              {platform}
            </span>
          </div>
