...
export function RequirementsPage() {
  ...
  const [newReq, setNewReq] = useState({
    ...
    type: undefined as 'inhouse' | 'outsourced' | undefined,
    dueDate: '',
    ...
    createRequirementMutation.mutate(
      {
        ...
        // Parsing custom date or default to now if missing
        ...
        // Backend might not accept invoiceAmount yet, so ignoring it
      } as any,
      {
        onSuccess: () => {
      ...
      <div className="flex flex-col h-full">
        <div className="mb-6 -mt-2">
          <TabBar
            ...
            activeTab={subTab}
            onTabChange={(tabId: string) => setSubTab(tabId as 'all' | 'in-progress' | 'completed' | 'delayed')}
          />
        </div>
      ...
      >
        <div className="p-0">
          ...
          <div className="space-y-6 max-h-[70vh] overflow-y-auto px-1">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                <span className="text-[14px] font-['Manrope:SemiBold',sans-serif] text-[#111111]">Type</span>
                <Select
                  className="w-full h-[46px] custom-modal-select"
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                <span className="text-[14px] font-['Manrope:SemiBold',sans-serif] text-[#111111]">Category</span>
                <Input
            ...
            {/* Row 4: Invoice Amount & Spacer (or future field) */}
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                <span className="text-[14px] font-['Manrope:SemiBold',sans-serif] text-[#111111]">Invoice Amount</span>
                <Input
                  placeholder="Enter invoice amount"
                  className="h-[46px] rounded-lg border-[#EEEEEE] bg-[#F7F7F7] focus:bg-white transition-colors font-['Manrope:Medium',sans-serif]"
                  value={newReq.invoiceAmount}
                  onChange={(e) => setNewReq({ ...newReq, invoiceAmount: e.target.value })}
                />
              </div>
              {/* Empty column placeholder to maintain grid size if needed, or leave blank */}
              <div></div>
            </div>
          ...
          <div className="flex items-center justify-end gap-4 pt-4 mt-8">
            ...
            <button
              ...
              className="h-[44px] px-8 rounded-lg bg-[#111111] hover:bg-[#000000]/90 text-white text-[14px] font-['Manrope:SemiBold',sans-serif] transition-transform active:scale-95"
            >
              Save Requirement
            </button>
          </div>
