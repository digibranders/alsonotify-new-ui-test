...
export function ReportsPage() {
  const [activeTab, setActiveTab] = useState<ReportType>('requirement');
          ...
          customFilters={
            <div className="flex items-center gap-3">
              ...
              <DateRangeSelector
                ...
                className="font-['Manrope:Medium',sans-serif] text-[12px]"
              />
            </div>
          }
        >
                          ...
                          <div className="flex items-center gap-4">
                            <div className="text-right hidden sm:block">
                              ...
                              <div className="w-16 h-1 bg-[#F0F0F0] rounded-full mt-1 overflow-hidden">
                                <div className="h-full bg-[#111111]" style={{ width: `${Math.min((task.engagedHrs / task.allottedHrs) * 100, 100)}%` }}></div>
                              </div>
                            </div>
                          </div>
                        </div>
