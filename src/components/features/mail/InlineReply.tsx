...
import { 
  ...
  MoreVertical, Trash2, Send, Forward
} from 'lucide-react';
...
interface InlineReplyProps {
  originalMessage: any;
  onSend: (data: { body: string; to: string[]; cc: string[]; subject: string }) => Promise<void>;
  onDiscard: () => void;
               ...
               <div className="flex items-center justify-between pt-2 border-t border-[#f0f0f0]">
                   <div className="flex items-center gap-2">
                       <Button 
                        ...
                        <FormatBtn icon={Paperclip} cmd="attachment" title="Attach" />
                   </div>
                   
                   <div className="flex items-center gap-1">
                       <button onClick={onDiscard} className="p-2 hover:bg-black/5 rounded text-[#555]">
                           <Trash2 size={16} />
                       </button>
                   </div>
               </div>
